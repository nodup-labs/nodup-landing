    ...
    <section id="contact" className="py-24 ">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <CustomSubtitle>
            سؤالی دارید یا می‌خواهید همکاری با نوداپ را شروع کنید؟ پیام دهید؛
            سریع پاسخ می‌دهیم
          </CustomSubtitle>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="mb-8">
                چه بخواهید روند کارتان را بهینه کنید، بهره‌وری را افزایش دهید یا
                عملیات کسب‌وکارتان را دگرگون سازید؛ ما همراه شما در مسیر موفقیت
                هستیم
              </p>
            </div>
