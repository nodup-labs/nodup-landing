      ...
      <div className="container mx-auto px-4 flex flex-col gap-32">
        <div className="flex flex-wrap justify-center items-center gap-3">
          <p className="text-sm md:text-base font-medium">
            تیم طراحی رابط و تجربه کاربری و وب، خلق تجربه‌های دیجیتال
            منحصربه‌فرد برای کسب‌وکار شما.
          </p>
          <Badge
            variant={"outline"}
        ...
        <div className="text-center mt-12 md:mt-20 mx-auto relative z-30 px-4">
          ...
          <p className="text-base md:text-xl font-normal text-center mt-4 ]">
            ما باور داریم ارائه‌ها باید فراتر از یک پرزنتیشن ساده باشند؛
            تجربه‌هایی تأثیرگذار و به‌یادماندنی خلق می‌کنیم
          </p>
        </div>
