      ...
      >
        <div className="flex flex-col items-center gap-6 md:gap-2 pb-16  md:text-left">
          ...
          <p className="text-base md:text-xl font-normal text-neutral-300  text-center  leading-10">
            ما کارمون رو به‌عنوان یه تیم پنج‌نفره شروع کردیم که باور داشتیم
            طراحی و کدنویسی باید کاری فراتر از زیبا بودن انجام بدن — باید زندگی
            رو راحت‌تر، هوشمندتر و انسانی‌تر کنن. امروز ما یه تیم جهانی هستیم که
